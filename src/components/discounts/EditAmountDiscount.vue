  ...
  <div class="form-dark">
    <div class="form-row">
      <div class="col-12 col-lg-6">
        ...
        <div class="form-group">
          <label for="min_bill" class="text-uppercase">Montant minimum du panier</label>
          <input type="number" class="form-control" v-model="discount.min_bill" />
        </div>

        <div class="form-group">
          <label for="min_bill" class="text-uppercase">Appliquer les points de fidélité sur</label>
...
export default {
  ...
  methods: {
    getDiscount() {
      ...
      this.$http.get('/discounts/amount/'+this.instance).then(resp => {
    ...
    validate() {
      ...
      if(this.discount.name == '' || this.discount.min_bill == '' || this.discount.code == '' || this.discount.amount == '' || this.discount.description == '') {
    ...
    editDiscount() {
      if(this.validate()) {
        ...
        this.$http.put('/discounts/amount/'+this.discount.id, this.discount).then(resp => {
