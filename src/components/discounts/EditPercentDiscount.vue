...
export default {
  ...
  methods: {
    ...
    this.$http.get('/discounts/percent/'+this.instance).then(resp => {
    ...
    validate() {
      ...
      if(this.discount.name == '' || this.discount.code == '' || this.discount.amount == '' || this.discount.description == '') {
    ...
    editDiscount() {
      if(this.validate()) {
        ...
        this.$http.put('/discounts/percent/'+this.discount.id, this.discount).then(resp => {
